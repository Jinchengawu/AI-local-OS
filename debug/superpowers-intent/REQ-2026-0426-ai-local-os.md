# REQ-2026-0426：AI-local-OS（OpenClaw + Hermes 私有化本地智能操作系统）
...
| **来源文档** | `AI-local-OS：OpenClaw+Hermes 私有化本地智能操作系统方案.pdf`（仓库根目录） |
| **分支** | （待填） |
| **PR** | （待填） |
| **负责人** | （待填） |
| **创建时间** | 2026-04-26 |
...
- 基于 PDF 方案，将 **AI-local-OS** 定义为：**OpenClaw（全局调度内核）+ 多实例 Hermes（垂类心智单元）** 的私有化、全本地智能操作系统。
...
2. **OpenClaw**：自定义插件「AI-local-OS 垂类心智调度器」；注册各 Hermes 的 URL、Key、垂类标签；配置上述路由规则。

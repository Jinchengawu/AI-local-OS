...
**关联规格：** [docs/specs/2026-04-26-ai-local-os-design.md](../specs/2026-04-26-ai-local-os-design.md)  
**侧车 REQ：** [debug/superpowers-intent/REQ-2026-0426-ai-local-os.md](../../debug/superpowers-intent/REQ-2026-0426-ai-local-os.md)
...
- 创建：`docs/ai-local-os/routing-rules.md`
...
- 创建：`docs/ai-local-os/hermes-instances.template.yaml`
...
- 创建：`docs/ai-local-os/.env.example`
...
- 修改：`debug/superpowers-intent/REQ-2026-0426-ai-local-os.md`
...
- [x] **步骤 1：** 增加指向 `docs/ai-local-os/README.md` 的一行索引（最小改动）。
...
- [ ] （未激活）新增 `docs/ai-local-os/iac/README.md` 与 Compose/Ansible 示例。
...
- [ ] **步骤 4：** 将 §2 链接摘要同步到侧车 [REQ-2026-0426-ai-local-os.md](../../debug/superpowers-intent/REQ-2026-0426-ai-local-os.md)「产品与 API 文档链接」节。

- [ ] **步骤 5：** 在规格 [§6](../specs/2026-04-26-ai-local-os-design.md) 或 REQ 勾选「待补材料」对应项（团队约定单一 SSOT 即可）。
